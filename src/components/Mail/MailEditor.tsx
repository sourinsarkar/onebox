...
export function MailEditor() {
    ...
    return (
        <div className="w-full mx-5 border-[1px] border-[#DEDEDE] bg-[#FAFAFA] py-3 px-4 rounded-lg">
            <section className="flex justify-between items-center">
                <h2>Reply</h2>
                <RiCloseFill  onClick={handleIsOpenClick} size={24} className="bg-[#d0a6a6] p-1 rounded-full"/>
            </section>
            <section>
                <div className="py-3 border-b-[1px] border-[#DEDEDE] flex items-center">
                    <p className="text-xs">To:</p>
                    <input type="text" className="w-full bg-[#FAFAFA] outline-none" />
                </div>
                <div className="py-3 border-b-[1px] border-[#DEDEDE] flex items-center">
            ...
            <section>
                <textarea className={`w-full bg-[#FAFAFA] outline-none h-64 p-4 ${isBold ? 'font-bold' : ''} ${isItalic ? 'italic' : 'not-italic'}`}
